                                ...
                                @foreach($subjects as $subject)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if(auth()->user()->role=='1')
                                                <button data-href="{{route('staff.subject-major.deleteSubject',['id'=>$subject->id])}}" class="btn btn-circle waves-effect waves-float waves-circle delete-button"><i class="zmdi zmdi-delete text-danger"></i></button>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
