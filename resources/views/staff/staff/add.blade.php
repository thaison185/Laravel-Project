...
@section('content')
    <form  method="post" enctype="multipart/form-data" id="needs-validation" action="{{route('staff.students.store')}}">
        @csrf
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>Basic Information <small>Some information of new student</small> </h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control phone-number" placeholder="Phone Number" name="phone" required>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h2>Student's Account Information <small>Email and Password for new Student</small></h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
