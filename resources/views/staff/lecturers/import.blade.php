...
@section('content')
    <form  method="post" enctype="multipart/form-data" id="needs-validation" action="{{route('staff.lecturers.import')}}">
        @csrf
    ...
    <script>
        $(function(){
            ...
            function renderRow(data,fail,index,target){
                ...
                const order=['name','email','password','faculty_id','gender','dob','title','degree','description'];
